                        ...
                        if ( true == $notice['dismiss'] ) {
                            ...
                            if ( ! get_user_meta( $userid, 'ignore_' . $notice['id'] ) ) {
                                ...
                                if ( version_compare( $wp_version, '4.2', '>' ) ) {
                                    ...
                                    print '<div ' . $add_style . ' class="' . $notice['type'] . ' notice is-dismissable"><p>' . $notice['msg'] . '&nbsp;&nbsp;<a href="?dismiss=true&amp;id=' . $notice['id'] . $pageName . $curTab . '">' . esc_html__( 'Dismiss', 'lapindos' ) . '</a>.</p></div>';
                                }
                            }
                        } else {
                            // Standard notice
                            print '<div ' . $add_style . ' class="' . $notice['type'] . ' notice"><p>' . $notice['msg'] . '</a>.</p></div>';
                        }
                        ?>
                        <script>
