    ...
    if ( ! class_exists( 'ReduxFramework_section' ) ) {
        ...
        class ReduxFramework_section {
            ...
            public function render() {
                ...
                echo '<div id="section-' . esc_attr($this->field['id']) . '" class="redux-section-field redux-field ' . sanitize_html_class($this->field['style']) . ' ' . sanitize_html_class($this->field['class']) . '">';

                if ( ! empty( $this->field['title'] ) ) {
                    echo '<h3 class="section-heading">' . esc_html($this->field['title']) . '</h3>';
                }
                ...
                echo '</div><table id="section-table-' . esc_attr($this->field['id']) . '" data-id="' . esc_attr($this->field['id']) . '" class="form-table form-table-section no-border' . sanitize_html_class($add_class) . '"><tbody><tr><th></th><td id="' . esc_attr($guid) . '">';
