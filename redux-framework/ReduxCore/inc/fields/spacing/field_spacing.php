    ...
    class ReduxFramework_spacing {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="redux-spacing-all redux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'All', 'lapindos' ) . '" rel="' . esc_attr($this->field['id']) . '-all" value="' . esc_attr($this->value['top']) . '"></div>';
            }

            if ( $this->field['top'] === true ) {
                echo '<input type="hidden" class="redux-spacing-value" id="' . esc_attr( $this->field['id'] ) . '-top" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[' . $this->field['mode'] . 'top]' . '" value="' . esc_attr( $this->value['top']) . ( ! empty( $this->value['top'] ) ? esc_attr($this->value['units']) : '' ) . '">';
            }

            if ( $this->field['right'] === true ) {
                echo '<input type="hidden" class="redux-spacing-value" id="' . esc_attr( $this->field['id'] ) . '-right" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[' . $this->field['mode'] . 'right]' . '" value="' . esc_attr( $this->value['right']) . ( ! empty( $this->value['right'] ) ? esc_attr($this->value['units']) : '' ) . '">';
            }

            if ( $this->field['bottom'] === true ) {
                echo '<input type="hidden" class="redux-spacing-value" id="' . esc_attr( $this->field['id'] ) . '-bottom" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[' . $this->field['mode'] . 'bottom]' . '" value="' . esc_attr( $this->value['bottom']) . ( ! empty( $this->value['bottom'] ) ? esc_attr($this->value['units']) : '' ) . '">';
            }

            if ( $this->field['left'] === true ) {
                echo '<input type="hidden" class="redux-spacing-value" id="' . esc_attr( $this->field['id'] ) . '-left" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[' . $this->field['mode'] . 'left]' . '" value="' . esc_attr( $this->value['left']) . ( ! empty( $this->value['left'] ) ? esc_attr($this->value['units']) : '' ) . '">';
            }
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                 ...
                 * */
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="redux-spacing-top redux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Top', 'lapindos' ) . '" rel="' . esc_attr($this->field['id']) . '-top" value="' . esc_attr($this->value['top']) . '"></div>';
                }
                 ...
                 * */
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="redux-spacing-left redux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Left', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-left" value="' . esc_attr($this->value['left']) . '"></div>';
                }
            }
            ...
            if ( $this->field['units'] !== false && is_array( $this->field['units'] ) && $this->field['display_units'] == true ) {
                ...
                echo '<div class="select_wrapper spacing-units" original-title="' . esc_attr__( 'Units', 'lapindos' ) . '">';
                echo '<select data-placeholder="' . esc_attr__( 'Units', 'lapindos' ) . '" class="redux-spacing redux-spacing-units select ' . $this->field['class'] . '" original-title="' . esc_attr__( 'Units', 'lapindos' ) . '" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix']) . '[units]' . '" id="' . esc_attr($this->field['id']) . '_units">';
                ...
                if ( in_array( $this->field['units'], $testUnits ) ) {
                    echo '<option value="' . esc_attr( $this->field['units']) . '" selected="selected">' . esc_html( $this->field['units']) . '</option>';
                } else {
