        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                foreach ( $this->field['options'] as $k => $v ) {
                    ...
                    if ( ! empty( $this->field['tiles'] ) && $this->field['tiles'] == true ) {
                        echo '<span class="tiles ' . $v['class'] . '" style="background-image: url(' . esc_url( $v['img']) . ');" rel="' . $v['img'] . '"">&nbsp;</span>';
                    } else {
                        echo '<img src="'.esc_url( $v['img']). '" alt="' .esc_attr( $v['alt'] ) . '" class="' . $v['class'] . '" style="' . $style . '"' . $presets . $merge . ' />';
                    }
