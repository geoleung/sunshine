    ...
    if ( ! class_exists( 'ReduxFramework_dimensions' ) ) {
        class ReduxFramework_dimensions {
            ...
            function render() {
                ...
                echo '<fieldset id="' . $this->field['id'] . '" class="redux-dimensions-container" data-id="' . esc_attr($this->field['id']) . '">';
                ...
                if ( $this->field['width'] === true ) {
                    ...
                    echo '<input type="text" class="redux-dimensions-input redux-dimensions-width mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Width', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-width" value="' . filter_var( $this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                    echo '<input data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-width" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix']) . '[width]' . '" value="' . esc_attr( $this->value['width']) . '"></div>';
                }
                ...
                if ( $this->field['height'] === true ) {
                    ...
                    echo '<input type="text" class="redux-dimensions-input redux-dimensions-height mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Height', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-height" value="' . filter_var( $this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                    echo '<input data-id="' . esc_attr( $this->field['id'])  . '" type="hidden" id="' . $this->field['id'] . '-height" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix']) . '[height]' . '" value="' . esc_attr( $this->value['height'] ) . '"></div>';
                }
                ...
                if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
                    echo '<div class="select_wrapper dimensions-units" original-title="' . esc_attr__( 'Units', 'lapindos' ) . '">';
                    echo '<select data-id="' . esc_attr( $this->field['id'] ). '" data-placeholder="' . esc_attr__( 'Units', 'lapindos' ) . '" class="redux-dimensions redux-dimensions-units select ' . $this->field['class'] . '" original-title="' . esc_attr__( 'Units', 'lapindos' ) . '" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix']) . '[units]' . '">';
