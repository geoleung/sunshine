    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'lapindos' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'lapindos' ) . '</strong>';
            }
        }
