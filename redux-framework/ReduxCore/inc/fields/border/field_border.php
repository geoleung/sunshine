    ...
    class ReduxFramework_border {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="redux-border-all redux-border-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'All', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-all" value="' . esc_attr( $this->value['top']) . '"></div>';
            }

            echo '<input type="hidden" class="redux-border-value" id="' . esc_attr( $this->field['id'] ) . '-top" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ). '[border-top]" value="' . ( $this->value['top'] ? esc_attr( $this->value['top']) . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="redux-border-value" id="' . esc_attr( $this->field['id'] ) . '-right" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ). '[border-right]" value="' . ( $this->value['right'] ? esc_attr( $this->value['right']) . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="redux-border-value" id="' . esc_attr( $this->field['id'] ) . '-bottom" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ). '[border-bottom]" value="' . ( $this->value['bottom'] ? esc_attr( $this->value['bottom']) . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="redux-border-value" id="' . esc_attr( $this->field['id'] ) . '-left" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ). '[border-left]" value="' . ( $this->value['left'] ? esc_attr( $this->value['left']) . 'px' : 0 ) . '">';
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                ...
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="redux-border-top redux-border-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Top', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-top" value="' . esc_attr( $this->value['top']) . '"></div>';
                }
                ...
                if ( $this->field['right'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="redux-border-right redux-border-input mini ' . $this->field['class'] . '" placeholder="' . esc_attr__( 'Right', 'lapindos' ) . '" rel="' . esc_attr( $this->field['id']) . '-right" value="' . esc_attr( $this->value['right']) . '"></div>';
                }
                ...
                if ( $this->field['bottom'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="redux-border-bottom redux-border-input mini ' . $this->field['class'] . '" placeholder="' . esc_html__( 'Bottom', 'lapindos' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
                }
                ...
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="redux-border-left redux-border-input mini ' . $this->field['class'] . '" placeholder="' . esc_html__( 'Left', 'lapindos' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
                }
            }
            ...
            if ( $this->field['style'] != false ) {
                ...
                echo '<select original-title="' . esc_attr__( 'Border style', 'lapindos' ) . '" id="' . esc_attr($this->field['id']) . '[border-style]" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[border-style]" class="tips redux-border-style ' . $this->field['class'] . '" rows="6" data-id="' . esc_attr($this->field['id']) . '">';
                foreach ( $options as $k => $v ) {
                    echo '<option value="' . esc_attr( $k ) . '"' . selected( $value['style'], $k, false ) . '>' . esc_html( $v ) . '</option>';
                }
                echo '</select>';
            } else {
                echo '<input type="hidden" id="' . esc_attr($this->field['id']) . '[border-style]" name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix']) . '[border-style]" value="' . esc_attr($this->value['style']) . '" data-id="' . esc_attr($this->field['id']) . '">';
            }
            ...
            if ( $this->field['color'] != false ) {
                ...
                echo '<input name="' . wp_strip_all_tags( $this->field['name'] . $this->field['name_suffix'] ) . '[border-color]" id="' . esc_attr( $this->field['id']) . '-border" class="redux-border-color redux-color redux-color-init ' . $this->field['class'] . '"  type="text" value="' . esc_attr($this->value['color']) . '"  data-default-color="' . $default . '" data-id="' . esc_attr($this->field['id']) . '" />';
            } else {
                echo '<input type="hidden" id="' . esc_attr($this->field['id']) . '[border-color]" name="' . wp_strip_all_tags($this->field['name'] . $this->field['name_suffix']) . '[border-color]" value="' . esc_attr($this->value['style']) . '" data-id="' . esc_attr($this->field['id']) . '">';
            }
        }
