...
class ReduxFramework_typography extends ThemegumReduxFramework{
    ...
    if ($this->field['font-family'] == true):
          ...
          echo '<div id="'.$this->field['id'].'" class="redux-typography-container" data-id="'.$this->field['id'].'" data-units="'.$unit.'">';
              ...
              echo '<select data-placeholder="'.esc_attr__('Font family','lapindos').'" class="redux-typography redux-typography-family '.$this->field['class'].'" id="'.$this->field['id'].'-family" data-id="'.$this->field['id'].'" data-value="'.$fontFamily[0].'">';
              ...
              if ( $this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                print '<optgroup label="'.esc_html__('Standard Fonts', 'lapindos').'">';  
              }
              foreach ($this->field['fonts'] as $i=>$family) {
                  print '<option data-google="false" data-details="'.$font_sizes.'" value="'. $i .'"' . selected($this->value['font-family'], $i, false) . '>'. $family .'</option>';
              }
              ...
              if ($this->field['google'] == true) { 
                // Set a flag so we know to set a header style or not
                  print '<input type="hidden" class="redux-typography-google'.$this->field['class'].'" id="'.$this->field['id'].'-google" name="'.$this->args['opt_name'].'['.$this->field['id'].'][google]" type="text" value="'. $this->field['google'] .'" data-id="'.$this->field['id'].'" />';            
              }
            ...
            if ($this->field['font-style'] == true || $this->field['font-weight'] == true):
                echo '<div class="select_wrapper typography-style" original-title="'.esc_attr__('Font style','lapindos').'">';
              $style = $this->value['font-weight'].$this->value['font-style'];
                ...
                echo '<select data-placeholder="'.esc_attr__('Style','lapindos').'" class="redux-typography redux-typography-style select'.$this->field['class'].'" original-title="'.esc_attr__('Font style','lapindos').'" id="'. $this->field['id'].'_style" data-id="'.$this->field['id'].'" data-value="'.$style.'">';
            ...
            if ($this->field['subsets'] == true && $this->field['google'] == true):
                echo '<div class="select_wrapper typography-script tooltip" original-title="'.esc_attr__('Font subsets','lapindos').'">';
                echo '<select data-placeholder="'.esc_attr__('Subsets','lapindos').'" class="redux-typography redux-typography-subsets'.$this->field['class'].'" original-title="'.esc_attr__('Font script','lapindos').'"  id="'.$this->field['id'].'-subsets" name="'.$this->args['opt_name'].'['.$this->field['id'].'][subsets]" data-value="'.$this->value['subsets'].'" data-id="'.$this->field['id'].'" >';
            ...
            if ($this->field['font-family'] == true && $this->field['google'] == true) { 
              // Set a flag so we know to set a header style or not
                ...
                if ($this->field['font-backup'] == true) {
                  ...
                  echo '<select data-placeholder="'.esc_attr__('Backup Font Family','lapindos').'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][font-backup]" class="redux-typography redux-typography-family-backup '.$this->field['class'].'" id="'.$this->field['id'].'-family-backup" data-id="'.$this->field['id'].'" data-value="'.$this->value['font-backup'].'">';
                  echo '<option data-google="false" data-details="" value=""></option>';
                  foreach ($this->field['fonts'] as $i=>$family) {
            ...
            if ($this->field['color'] == true):
                ...
                echo '<input data-default-color="'.$default.'" class="redux-color redux-typography-color'.$this->field['class'].'" original-title="'.esc_attr__('Font color','lapindos').'" id="'.$this->field['id'].'-color" name="'.$this->args['opt_name'].'['.$this->field['id'].'][color]" type="text" value="'. $this->value['color'] .'" data-id="'.$this->field['id'].'" />';
            endif;
      ...
      foreach( $this->parent->sections as $section ) {
        ...
        if( isset( $section['fields'] ) ) {
          foreach( $section['fields'] as $field ) {
            if( isset( $field['type'] ) && isset($field['id']) && isset($this->parent->options[$field['id']] )  && $field['type'] == "typography" ) {

              $font = $this->parent->options[$field['id']];
              if ( isset($font['font-family']) && !empty( $font['font-family'] ) && !empty( $font['font-backup'] ) ) {
                $font['font-family'] = str_replace( ', '.$font['font-backup'], '', $font['font-family'] );  
              }
              if ( isset($field['output']) && !empty( $field['output'] ) ) : // Don't create dynamic CSS if output array is not set
    ...
    */
    ...
    function getGoogleFonts() {
        ...
        $gfonts = '<optgroup label="'.esc_html__('Google Webfonts', 'lapindos').'">';
